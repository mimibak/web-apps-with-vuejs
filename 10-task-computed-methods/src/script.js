Vue.createApp({
  ...
  methods: {
    getDiscount(dollar, discount) {
      //String wird von Nummer getrennt (Splitten das Dollarzeichen vom Numerischen Wert)
      const [, priceOnly] = dollar.split("$");
      //Berechnung der 20% auf den originalpreis
      const discountValue = (priceOnly / 100) * discount;
      //Dollarzeichen(String) wird addiert zur (originalpreis - Wert des Rabattes (20%)).toFixed(2)- bestimmt die Dezimalstellen hinter dem Hauptwert.)
